    ...
    <body>
        <div>
            ...
            <section class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="formation-head">Formations</h2>
                    </div>
                </div>
                    ...
                    <?php
                        while($infos=$formation->fetch()){
                           echo '<div class="card col-md-4">
                              <img class="card-img-top" src="http://localhost/fablab-admin/production/php/formation/fichier_uploaded/'.$infos['image_formation'].'" alt="Card image cap">
                              <div class="card-body">
                                <h5 class="card-title">'.$infos['titre_formation'].'</h5>
                                <p class="card-text">'.$infos['description_formation'].'</p>
                                <a href="'.$infos['lien_formation'].'" class="btn btn-primary btn-card">Go somewhere</a>
                              </div>
                            </div>';
